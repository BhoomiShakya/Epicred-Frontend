  ...
  return (
    <div className="relative w-[85%] mx-auto h-[400px] md:h-[450px] overflow-hidden mb-[3rem]">
      ...
      <Image
        ...
        className="z-0"
      />
      <div className="relative z-10 flex justify-between items-center h-full px-8 md:px-20">
        <div className="text-white max-w-md space-y-4">
          ...
          <button className="bg-white text-[#4640DE] px-8 py-4  font-bold text-sm hover:bg-gray-200 transition">
            Sign Up For Free
          </button>
        </div>
        <div className="hidden md:block  mt-[6rem]">
